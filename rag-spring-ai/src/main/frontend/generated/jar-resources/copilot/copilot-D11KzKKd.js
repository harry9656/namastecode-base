...
}, co = process.env.NODE_ENV !== "production" ? lo : {};
...
function Sn() {
    return typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : uo;
}
...
var Nn = {};
Object.freeze(Nn);
var ho = typeof Proxy < "u", fo = /* @__PURE__ */ Object.toString();

function Cr() {
    ho || f(process.env.NODE_ENV !== "production" ? "`Proxy` objects are not available in the current environment. Please configure MobX to enable a fallback implementation.`" : "Proxy not available");
}
...
function D(e) {
    ...
    return typeof n == "function" && n.toString() === fo;
}
...
var at = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : Vr ? function (e) {
...
function Ke(e, t, n) {
    return t && bo(e.prototype, t), Object.defineProperty(e, "prototype", {
        writable: !1
    }), e;
}
...
function Mr(e, t, n) {
    ...
    var r = new fe(e);
    return t !== Me && Va(r, t), n !== Me && ci(r, n), r;
}
...
function Ae(e, t, n) {
    return ct(e) ? e : Array.isArray(e) ? S.array(e, {
        ...
        name: n
    }) : typeof e == "function" && !Ue(e) && !lt(e) ? kr(e) ? ze(e) : st(n, e) : e;
}

function No(e, t, n) {
    if (e == null || We(e) || Yt(e) || ve(e) || J(e))
        return e;
    if (Array.isArray(e))
        return S.array(e, {
            name: n,
...
function Lr(e, t, n, r, i) {
    var o, a, l, s, c, u, d;
    i === void 0 && (i = h.safeDescriptors), ko(e, t, n, r);
    var v = r.value;
...
function To(e, t, n, r) {
    ...
    if (r === e.target_)
        return this.extend_(e, t, n, !1) === null ? 0 : 2;
    if ((i = this.options_) != null && i.bound && (!F(e.target_, t) || !lt(e.target_[t])) && this.extend_(e, t, n, !1) === null)
        return 0;
    if (lt(n.value))
        return 1;
...
function Ur(e, t, n, r, i, o) {
    o === void 0 && (o = h.safeDescriptors), Ro(e, t, n, r);
    var a = r.value;
    if (lt(a) || (a = ze(a)), i) {
        var l;
...
function Lo(e, t, n, r) {
    return Uo(e, this, t, n), e.defineComputedProperty_(t, de({}, this.options_, {
        get: n.get,
        set: n.set
    }), r);
}
...
function Bo(e, t, n, r) {
    var i, o;
    return Fo(e, this, t, n), e.defineObservableProperty_(t, n.value, (i = (o = this.options_) == null ? void 0 : o.enhancer) != null ? i : Ae, r);
}
...
function Ho(e, t) {
    ...
    function a(l, s) {
        var c, u, d = qe(l)[p],
            v = new Ee(s, (c = (u = n.options_) == null ? void 0 : u.enhancer) != null ? c : Ae, process.env.NODE_ENV !== "production" ? d.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
var Xo = "observable", Zo = "observable.ref", Yo = "observable.shallow", Qo = "observable.struct", Br = {
    deep: !0,
    name: void 0,
...
var pn = /* @__PURE__ */ qt(Xo), ea = /* @__PURE__ */ qt(Zo, {
    enhancer: Kt
}), ta = /* @__PURE__ */ qt(Yo, {
    enhancer: No
}), na = /* @__PURE__ */ qt(Qo, {
...
function wt(e) {
    return e.deep === !0 ? Ae : e.deep === !1 ? Kt : ia(e.defaultDecorator);
}
...
function Fr(e, t, n) {
    ...
    return ct(e) ? e : D(e) ? S.object(e, t, n) : Array.isArray(e) ? S.array(e, t) : Fe(e) ? S.map(e, t) : te(e) ? S.set(e, t) : typeof e == "object" && e !== null ? e : S.box(e, t);
}
...
var oa = {
        box: function (t, n) {
            var r = yt(n);
            return new Ee(t, wt(r), r.name, !0, r.equals);
        },
        array: function (t, n) {
            var r = yt(n);
            return (h.useProxies === !1 || r.proxy === !1 ? ns : qa)(t, wt(r), r.name);
        },
        map: function (t, n) {
            var r = yt(n);
            return new pi(t, wt(r), r.name);
        },
        set: function (t, n) {
            var r = yt(n);
            return new gi(t, wt(r), r.name);
        },
        object: function (t, n, r) {
            return Te(function () {
                return di(h.useProxies === !1 || r?.proxy === !1 ? qe({}, r) : Ha({}, r), t, n);
            });
        },
        ref: /* @__PURE__ */ Y(ea),
        shallow: /* @__PURE__ */ Y(ta),
        deep: Hr,
        struct: /* @__PURE__ */ Y(na)
    }, S = /* @__PURE__ */ $r(Fr, oa), Kr = "computed", aa = "computed.struct", gn = /* @__PURE__ */ Dn(Kr),
    sa = /* @__PURE__ */ Dn(aa, {
        equals: Ie.structural
    }), Wt = function (t, n) {
        if (pt(n))
            return gn.decorate_20223_(t, n);
        if (Oe(n))
            return vt(t, n, gn);
        if (D(t))
            return Y(Dn(Kr, t));
...
Object.assign(Wt, gn);
Wt.struct = /* @__PURE__ */ Y(sa);
var Kn, qn, Tt = 0, la = 1, ca = (Kn = (qn = /* @__PURE__ */ $t(function () {
...
function da(e) {
    Tt !== e.actionId_ && f(30), Tt = e.parentActionId_, e.error_ !== void 0 && (h.suppressReactionErrors = !0), Jt(e.prevAllowStateChanges_), nt(e.prevAllowStateReads_), I(), e.runAsAction_ && oe(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && V({
...
var fa = "create", Ee = /* @__PURE__ */ function (e) {
    ...
    return t.onBecomeStale_ = function () {
        ...
        this.observers_.size === 0 && !this.keepAlive_)
            bn(this) && (this.warnAboutUntrackedRead_(), L(), this.value_ = this.computeValue_(!1), I());
        else if (Yr(this), bn(this)) {
            var r = h.trackingContext;
            this.keepAlive_ && !r && (h.trackingContext = this), this.trackAndCompute() && _a(this), h.trackingContext = r;
        }
        var i = this.value_;
        if (Nt(i))
            throw i.cause;
        ...
        this.keepAlive_ || (_n(this), this.value_ = void 0, process.env.NODE_ENV !== "production" && this.isTracing_ !== U.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' was suspended and it will recompute on the next access."));
...
function Wr(e, t, n) {
    ...
    return h.inBatch--, h.trackingDerivation = i, ga(e), pa(e), nt(r), o;
}
...
}, on = !0, h = /* @__PURE__ */ function () {
    var e = /* @__PURE__ */ Sn();
    return e.__mobxInstanceCount > 0 && !e.__mobxGlobals && (on = !1), e.__mobxGlobals && e.__mobxGlobals.version !== new rn().version && (on = !1), on ? e.__mobxGlobals ? (e.__mobxInstanceCount += 1, e.__mobxGlobals.UNCHANGED || (e.__mobxGlobals.UNCHANGED = {}), e.__mobxGlobals) : (e.__mobxInstanceCount = 1, e.__mobxGlobals = /* @__PURE__ */ new rn()) : (setTimeout(function () {
        f(35);
    }, 1), new rn());
}();
...
function ei(e, t) {
    if (console.log("[mobx.trace] '" + e.name_ + "' is invalidated due to a change in: '" + t.name_ + "'"), e.isTracing_ === U.BREAK) {
        var n = [];
        ti(ja(e), n, 1), new Function(`debugger;
/*
Tracing '` + e.name_ + `'
...
var ee = /* @__PURE__ */ function () {
    ...
    return t.onBecomeStale_ = function () {
        ...
        if (!this.isDisposed) {
            ...
            var r = h.trackingContext;
            if (h.trackingContext = this, bn(this)) {
        ...
        if (!this.isDisposed) {
            ...
            h.trackingContext = a, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && _n(this), Nt(l) && this.reportExceptionInDerivation_(l.cause), process.env.NODE_ENV !== "production" && i && V({
                time: Date.now() - o
            }), I();
        }
        ...
        this.isDisposed || (this.isDisposed = !0, this.isRunning || (L(), _n(this), I()));
...
var Gn = 100, wa = function (t) {
    return t();
};

function ni() {
    h.inBatch > 0 || h.isRunningReactions || wa(Ea);
}
...
var Cn = "action", Sa = "action.bound", ri = "autoAction", Na = "autoAction.bound", ii = "<unnamed action>",
    mn = /* @__PURE__ */ gt(Cn), xa = /* @__PURE__ */ gt(Sa, {
        bound: !0
    }), yn = /* @__PURE__ */ gt(ri, {
        autoAction: !0
    }), Pa = /* @__PURE__ */ gt(Na, {
...
function oi(e) {
    var t = function (r, i) {
        if (A(r))
            return Se(r.name || ii, r, e);
        if (A(i))
            return Se(r, i, e);
        if (pt(i))
            return (e ? yn : mn).decorate_20223_(r, i);
        if (Oe(i))
            return vt(r, i, e ? yn : mn);
        if (Oe(r))
            return Y(gt(e ? ri : Cn, {
                name: r,
                autoAction: e
...
var ye = /* @__PURE__ */ oi(!1);
Object.assign(ye, mn);
var st = /* @__PURE__ */ oi(!0);
Object.assign(st, yn);
ye.bound = /* @__PURE__ */ Y(xa);
st.bound = /* @__PURE__ */ Y(Pa);
...
function ai(e, t) {
    ...
    var a = (n = (r = t) == null ? void 0 : r.name) != null ? n : process.env.NODE_ENV !== "production" ? e.name || "Autorun@" + B() : "Autorun",
        l = !t.scheduler && !t.delay, s;
    if (l)
        s = new ee(a, function () {
            this.track(d);
...
function li(e, t, n) {
    ...
    var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction",
        l = ye(a, n.onError ? Ca(n.onError, t) : t), s = !n.scheduler && !n.delay, c = si(n), u = !0, d = !1, v,
        g = n.compareStructural ? Ie.structural : n.equals || Ie.default, _ = new ee(a, function () {
            u || s ? w() : d || (d = !0, c(w));
...
function hi(e) {
    ...
    return e.observing_ && e.observing_.length > 0 && (t.dependencies = Ra(e.observing_).map(hi)), t;
}
...
var an = /* @__PURE__ */ Ir("flow"), La = /* @__PURE__ */ Ir("flow.bound", {
    bound: !0
    ...
    var r = t, i = r.name || "<unnamed flow>", o = function () {
        var l = this, s = arguments, c = ++Ma, u = ye(i + " - runid: " + c + " - init", r).apply(l, s), d, v = void 0,
            g = new Promise(function (_, w) {
                var N = 0;
                d = w;
...
function Ia(e, t) {
    return e ? We(e) || !!e[p] || Pn(e) || jt(e) || Xt(e) : !1;
}
...
function Ha(e, t) {
    var n, r;
    return Cr(), e = qe(e, t), (r = (n = e[p]).proxy_) != null ? r : n.proxy_ = new Proxy(e, Ba);
}
...
function Zt(e, t, n) {
    return process.env.NODE_ENV !== "production" && (!D(e) && !D(Object.getPrototypeOf(e)) && f("'makeAutoObservable' can only be used for classes that don't have a superclass"), We(e) && f("makeAutoObservable can only be used on objects not already made observable")), D(e) ? di(e, e, t, n) : (Te(function () {
        var r = qe(e, n)[p];
        if (!e[sn]) {
            var i = Object.getPrototypeOf(e), o = new Set([].concat(at(e), at(i)));
            o.delete("constructor"), o.delete(p), Ht(i, sn, o);
        }
...
var Xn = "splice", H = "update", Fa = 1e4, Ka = {
    get: function (t, n) {
        var r = t[p];
...
var Wa = /* @__PURE__ */ Ce("ObservableArrayAdministration", kn);

function Yt(e) {
    return Bt(e) && Wa(e[p]);
}

var Ga = {}, ce = "add", Mt = "delete", pi = /* @__PURE__ */ function () {
    function e(n, r, i) {
        var o = this;
        r === void 0 && (r = Ae), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + B() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[p] = Ga, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = r, this.name_ = i, A(Map) || f(18), Te(function () {
    ...
    return t.has_ = function (r) {
        ...
        if (!o) {
            var a = o = new Ee(this.has_(r), Kt, process.env.NODE_ENV !== "production" ? this.name_ + "." + fn(r) + "?" : "ObservableMap.key?", !1);
        ...
        X(this.keysAtom_), re(function () {
            var c,
                u = new Ee(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + fn(r) : "ObservableMap.key", !1);
        ...
        return ve(r) && (r = new Map(r)), re(function () {
            D(r) ? po(r).forEach(function (o) {
                return i.set(o, r[o]);
            }) : Array.isArray(r) ? r.forEach(function (o) {
                var a = o[0], l = o[1];
                return i.set(a, l);
            }) : Fe(r) ? (vo(r) || f(19, r), r.forEach(function (o, a) {
                return i.set(a, o);
            })) : r != null && f(20, r);
        }), this;
    }, t.clear = function () {
        ...
        var i = this;
        return re(function () {
            for (var o = Ja(r), a = /* @__PURE__ */ new Map(), l = !1, s = Le(i.data_.keys()), c; !(c = s()).done;) {
                var u = c.value;
                if (!o.has(u)) {
                    var d = i.delete(u);
                    if (d)
...
}(), ve = /* @__PURE__ */ Ce("ObservableMap", pi);

function Zn(e) {
    return e[Symbol.toStringTag] = "MapIterator", jn(e);
}
...
var Xa = {}, gi = /* @__PURE__ */ function () {
    function e(n, r, i) {
        var o = this;
        r === void 0 && (r = Ae), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + B() : "ObservableSet"), this.name_ = void 0, this[p] = Xa, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, A(Set) || f(22), this.enhancer_ = function (a, l) {
            return r(a, l, i);
        }, Te(function () {
...
var Qn = /* @__PURE__ */ Object.create(null), er = "remove", wn = /* @__PURE__ */ function () {
    ...
    return t.getObservablePropValue_ = function (r) {
        ...
        return i || (i = new Ee(r in this.target_, Kt, process.env.NODE_ENV !== "production" ? this.name_ + "." + fn(r) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(r, i)), i.get();
...
function qe(e, t) {
    var n;
    if (process.env.NODE_ENV !== "production" && t && We(e) && f("Options can't be provided for already observable objects."), F(e, p))
        return process.env.NODE_ENV !== "production" && !(yi(e) instanceof wn) && f("Cannot convert '" + Lt(e) + `' into observable object:
...
Extending builtins is not supported.`), e;
    ...
    var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (D(e) ? "ObservableObject" : e.constructor.name) + "@" + B() : "ObservableObject",
        i = new wn(e, /* @__PURE__ */ new Map(), String(r), ra(t));
    return Ht(e, p, i), e;
}

var Za = /* @__PURE__ */ Ce("ObservableObjectAdministration", wn);
...
var Ya = /* @__PURE__ */ _i(0), Qa = /* @__PURE__ */ function () {
    var e = !1, t = {};
...
var Tn = /* @__PURE__ */ function (e) {
    function t(r, i, o, a) {
        ...
        return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableArray@" + B() : "ObservableArray"), a === void 0 && (a = !1), l = e.call(this) || this, Te(function () {
            ...
            s.proxy_ = l, Tr(l, p, s), r && r.length && l.spliceWithArray(0, 0, r), Qa && Object.defineProperty(l, "0", Ya);
        }), l;
    }
...
function Be(e, t) {
    if (typeof e == "object" && e !== null) {
        ...
        if (ve(e)) {
            ...
            return n || f(25, t, Lt(e)), n;
        }
        if (We(e)) {
            if (!t)
                return f(26);
            var r = e[p].values_.get(t);
            return r || f(27, t, Lt(e)), r;
        }
        if (Pn(e) || Xt(e) || jt(e))
            return e;
    } else if (A(e) && jt(e[p]))
...
function yi(e, t) {
    if (e || f(29), Pn(e) || Xt(e) || jt(e) || ve(e) || J(e))
        return e;
    if (e[p])
        return e[p];
    f(24, e);
...
function En(e, t, n, r, i) {
    ...
    if (r.push(e), i.push(t), l) {
        ...
        if (u = d.length, Object.keys(t).length !== u)
            return !1;
        for (; u--;)
            if (v = d[u], !(F(t, v) && En(e[v], t[v], n - 1, r, i)))
                return !1;
    }
...
function or(e) {
    return Yt(e) ? e.slice() : Fe(e) || ve(e) || te(e) || J(e) ? Array.from(e.entries()) : e;
}

var ar, rs = ((ar = Sn().Iterator) == null ? void 0 : ar.prototype) || {};

function jn(e) {
    return e[Symbol.iterator] = is, Object.assign(Object.create(rs), e);
}
...
const xe = "copilot-", as = "24.5.2", Ul = "attention-required",
    zl = "https://plugins.jetbrains.com/plugin/23758-vaadin",
    Bl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode",
    Hl = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, ss = (e) => {
        const t = [];
        let n = cs(e);
        for (; n;)
...
function ut(e) {
    return !e || !(e instanceof HTMLElement) ? !1 : [...ss(e), e].map((t) => t.localName).some((t) => t.startsWith(xe));
}
...
var Ei = /* @__PURE__ */ ((e) => (e["vaadin-combo-box"] = "vaadin-combo-box", e["vaadin-date-picker"] = "vaadin-date-picker", e["vaadin-dialog"] = "vaadin-dialog", e["vaadin-multi-select-combo-box"] = "vaadin-multi-select-combo-box", e["vaadin-select"] = "vaadin-select", e["vaadin-time-picker"] = "vaadin-time-picker", e["vaadin-popover"] = "vaadin-popover", e))(Ei || {});
const Xe = {
    "vaadin-combo-box": {
        hideOnActivation: !0,
        open: (e) => Et(e),
    ...
    "vaadin-select": {
        ...
        open: (e) => {
            const t = e;
            Ai(t, t._overlayElement), t.opened = !0;
        },
        close: (e) => {
            const t = e;
            Si(t, t._overlayElement), t.opened = !1;
        }
    },
    "vaadin-multi-select-combo-box": {
        ...
        close: (e) => {
            Ot(e.$.comboBox), e.removeAttribute("focused");
        }
    },
    "vaadin-date-picker": {
        hideOnActivation: !0,
    ...
    e.addEventListener("focusout", Oi, {capture: !0}), Ai(e), e.opened = !0;
}, Ot = (e) => {
    Si(e), e.removeAttribute("focused"), e.removeEventListener("focusout", Oi, {capture: !0}), e.opened = !1;
}, Ai = (e, t) => {
    const n = t ?? e.$.overlay;
...
class us {
    constructor() {
        this.openedOverlayOwners = /* @__PURE__ */ new Set(), this.overlayCloseEventListener = (t) => {
            ut(t.target?.owner) || (window.Vaadin.copilot._uiState.active || ut(t.detail.sourceEvent.target)) && (t.preventDefault(), t.stopImmediatePropagation());
        };
    }
    ...
    overlayStatus(t) {
        if (!t)
            return {visible: !1};
        const n = t.localName;
        let r = Object.keys(Ei).includes(n);
        if (!r)
            return {visible: !1};
...
function Pe(e, t) {
    Pi().then((n) => n.send(e, {...t, context: fs}));
}
...
class ps {
    constructor() {
        this.dismissedNotifications = [], this.termsSummaryDismissed = !1, this.activationButtonPosition = null, this.paletteState = null, this.activationShortcut = !0, this.activationAnimation = !0, Zt(this), this.initializer = new vs(), this.initializer.promise.then(() => {
            li(
                () => JSON.stringify(this),
                () => {
                    Pe("copilot-set-machine-configuration", {conf: JSON.stringify(lr(this))});
                }
            );
...
const Di = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n);
...
window.Vaadin.copilot._uiState = new os();
window.Vaadin.copilot.eventbus = new so();
window.Vaadin.copilot.overlayManager = new us();
window.Vaadin.copilot._machineState = new ps();
window.Vaadin.copilot._previewState = new gs();
window.Vaadin.copilot._sectionPanelUiState = new bs();
/**
 * @license
 ...
 */
const xt = globalThis,
    Rn = xt.ShadowRoot && (xt.ShadyCSS === void 0 || xt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    Mn = Symbol(), cr = /* @__PURE__ */ new WeakMap();
let $i = class {
    constructor(t, n, r) {
...
const le = (e) => new $i(typeof e == "string" ? e : e + "", void 0, Mn), ms = (e, ...t) => {
...
const {
        ...
        getOwnPropertyNames: As,
        getOwnPropertySymbols: Ss,
        getPrototypeOf: Ns
    } = Object, Qt = globalThis, dr = Qt.trustedTypes, xs = dr ? dr.emptyScript : "",
    Ps = Qt.reactiveElementPolyfillSupport, rt = (e, t) => e, On = {
        toAttribute(e, t) {
            switch (t) {
                case Boolean:
                    e = e ? xs : null;
    ...
    }, Ci = (e, t) => !ws(e, t), hr = {attribute: !0, type: String, converter: On, reflect: !1, hasChanged: Ci};
...
class Re extends HTMLElement {
    ...
    static getPropertyDescriptor(t, n, r) {
        const {get: i, set: o} = Os(this.prototype, t) ?? {
            get() {
                return this[n];
            }, set(a) {
                this[n] = a;
    ...
    static finalize() {
        ...
        if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(rt("properties"))) {
            const n = this.properties, r = [...As(n), ...Ss(n)];
    ...
    _$AK(t, n) {
        ...
        if (i !== void 0 && this._$Em !== i) {
            const o = r.getPropertyOptions(i),
                a = typeof o.converter == "function" ? {fromAttribute: o.converter} : o.converter?.fromAttribute !== void 0 ? o.converter : On;
...
Re.elementStyles = [], Re.shadowRootOptions = {mode: "open"}, Re[rt("elementProperties")] = /* @__PURE__ */ new Map(), Re[rt("finalized")] = /* @__PURE__ */ new Map(), Ps?.({ReactiveElement: Re}), (Qt.reactiveElementVersions ??= []).push("2.0.4");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ln = globalThis, It = Ln.trustedTypes, vr = It ? It.createPolicy("lit-html", {createHTML: (e) => e}) : void 0,
    In = "$lit$", ie = `lit$${Math.random().toFixed(9).slice(2)}$`, Un = "?" + ie, Cs = `<${Un}>`, De = document,
    dt = () => De.createComment(""), ht = (e) => e === null || typeof e != "object" && typeof e != "function",
    zn = Array.isArray, ki = (e) => zn(e) || typeof e?.[Symbol.iterator] == "function", cn = `[ 	
\f\r]`, Ze = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pr = /-->/g, gr = />/g,
    be = RegExp(`>|${cn}(?:([^\\s"'>=/]+)(${cn}*=${cn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), br = /'/g, _r = /"/g, Ti = /^(?:script|style|textarea|title)$/i,
    Vi = (e) => (t, ...n) => ({_$litType$: e, strings: t, values: n}), Ut = Vi(1), Zl = Vi(2),
    he = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), mr = /* @__PURE__ */ new WeakMap(),
    we = De.createTreeWalker(De, 129);
...
const Ri = (e, t) => {
    ...
    for (let l = 0; l < n; l++) {
        const s = e[l];
        let c, u, d = -1, v = 0;
        for (; v < s.length && (a.lastIndex = v, u = a.exec(s), u !== null);) v = a.lastIndex, a === Ze ? u[1] === "!--" ? a = pr : u[1] !== void 0 ? a = gr : u[2] !== void 0 ? (Ti.test(u[2]) && (i = RegExp("</" + u[2], "g")), a = be) : u[3] !== void 0 && (a = be) : a === be ? u[0] === ">" ? (a = i ?? Ze, d = -1) : u[1] === void 0 ? d = -2 : (d = a.lastIndex - u[2].length, c = u[1], a = u[3] === void 0 ? be : u[3] === '"' ? _r : br) : a === _r || a === br ? a = be : a === pr || a === gr ? a = Ze : (a = be, i = void 0);
        const g = a === be && e[l + 1].startsWith("/>") ? " " : "";
        o += a === Ze ? s + Cs : d >= 0 ? (r.push(c), s.slice(0, d) + In + s.slice(d) + ie + g) : s + ie + (d === -2 ? l : g);
    }
...
class ft {
    constructor({strings: t, _$litType$: n}, r) {
        ...
        if (this.el = ft.createElement(c, r), we.currentNode = this.el.content, n === 2 || n === 3) {
            ...
            if (i.nodeType === 1) {
                ...
                if (Ti.test(i.tagName)) {
                    ...
                    if (v > 0) {
                        ...
                        for (let g = 0; g < v; g++) i.append(d[g], dt()), we.nextNode(), s.push({type: 2, index: ++o});
                        i.append(d[v], dt());
                    }
                }
...
let en = class Li {
    ...
    _$AI(t, n = this) {
        t = $e(this, t, n), ht(t) ? t === O || t == null || t === "" ? (this._$AH !== O && this._$AR(), this._$AH = O) : t !== this._$AH && t !== he && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ki(t) ? this.k(t) : this._(t);
    }
    ...
    _(t) {
        this._$AH !== O && ht(this._$AH) ? this._$AA.nextSibling.data = t : this.T(De.createTextNode(t)), this._$AH = t;
    }

    $(t) {
        const {values: n, _$litType$: r} = t,
            i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = ft.createElement(ji(r.h, r.h[0]), this.options)), r);
    ...
    k(t) {
        ...
        const n = this._$AH;
        let r, i = 0;
        for (const o of t) i === n.length ? n.push(r = new Li(this.O(dt()), this.O(dt()), this, this.options)) : r = n[i], r._$AI(o), i++;
...
class mt {
    ...
    _$AI(t, n = this, r, i) {
        ...
        let a = !1;
        if (o === void 0) t = $e(this, t, n, 0), a = !ht(t) || t !== this._$AH && t !== he, a && (this._$AH = t);
        else {
            const l = t;
            let s, c;
            for (t = o[0], s = 0; s < o.length - 1; s++) c = $e(this, l[r + s], n, s), c === he && (c = this._$AH[s]), a ||= !ht(c) || c !== this._$AH[s], c === O ? t = O : t !== O && (t += (c ?? "") + o[s + 1]), this._$AH[s] = c;
        }
        a && !i && this.j(t);
    }
...
class zi extends mt {
    ...
    _$AI(t, n = this) {
        ...
        const r = this._$AH,
            i = t === O && r !== O || t.capture !== r.capture || t.once !== r.once || t.passive !== r.passive,
            o = t !== O && (r === O || i);
...
const ks = {M: In, P: ie, A: Un, C: 1, L: Ri, R: Mi, D: ki, V: $e, I: en, H: mt, N: Ui, U: zi, B: Ii, F: Bi},
    Ts = Ln.litHtmlPolyfillSupport;
Ts?.(ft, en), (Ln.litHtmlVersions ??= []).push("3.2.0");
const Vs = (e, t, n) => {
...
class it extends Re {
    ...
    update(t) {
        const n = this.render();
        this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this.o = Vs(n, this.renderRoot, this.renderOptions);
    }
...
function Ls() {
    me.push(import("./copilot-log-plugin-8vR7BSF2.js")), me.push(import("./copilot-info-plugin-BObP3033.js")), me.push(import("./copilot-features-plugin-J9OWmPtV.js")), me.push(import("./copilot-feedback-plugin-v8EmJ-5K.js")), me.push(import("./copilot-shortcuts-plugin-CRHRmXN8.js"));
}

function Is() {
    {
        const e = `https://cdn.vaadin.com/copilot/${as}/copilot-plugins.js`;
        import(
            /* @vite-ignore */
            e
            ).catch((t) => {
...
class zs {
    constructor() {
        this.active = !1, this.activate = () => {
            ...
            this.active && (t.preventDefault(), t.stopPropagation(), ut(t.target) || requestAnimationFrame(() => {
...
const At = new zs(), E = window.Vaadin.copilot.eventbus;
if (!E)
    throw new Error("Tried to access copilot eventbus before it was initialized.");
const Ye = window.Vaadin.copilot.overlayManager, Ql = {
...
var nn = /* @__PURE__ */ ((e) => (e.INFORMATION = "information", e.WARNING = "warning", e.ERROR = "error", e))(nn || {});
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Hi = {ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6},
    Fi = (e) => (...t) => ({_$litDirective$: e, values: t});
let Ki = class {
    constructor(t) {
    }
...
class An extends Ki {
    constructor(t) {
        if (super(t), this.it = O, t.type !== Hi.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
    }
...
function qi() {
    return import("./copilot-notification-C3QdZgiY.js");
}
...
`),
    ...
    Wi(e.error, e.message, e.stackTrace);
};

function qs(e, t) {
    Wi(e, t.message, t.stack || "");
}

function He(e, t) {
    qi().then(({showNotification: n}) => {
        n({
            type: nn.ERROR,
    ...
    window.Vaadin.ConsoleErrors = {
        push: (n) => {
            Da(() => {
                ...
                details: n[0].details,
                link: n[0].link
            }) : e({type: nn.ERROR, message: n.map((r) => Ws(r)).join(" "), internal: !1}), t.push(n);
        }
    };
}
...
const Yi = () => {
        Js().then((e) => b.setUserInfo(e)).catch((e) => He("Failed to load userInfo", e));
    }, Js = async () => Di(`${xe}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)),
    Xs = async () => xi(() => b.userInfo), rc = async () => (await Xs()).vaadiner;
...
const Or = (e) => {
        if (Qi.isActivationShortcut())
            if (e.key === "Shift" && !e.ctrlKey && !e.altKey && !e.metaKey)
                un = !0;
            else if (un && e.shiftKey && (e.key === "Control" || e.key === "Meta")) {
                if (Qe++, Qe === 2) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const eo = Symbol.for(""), il = (e) => {
    if (e?.r === eo) return e?._$litStatic$;
}, to = (e) => ({_$litStatic$: e, r: eo}), Ar = /* @__PURE__ */ new Map(), ol = (e) => (t, ...n) => {
    const r = n.length;
    let i, o;
    const a = [], l = [];
    let s, c = 0, u = !1;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const {I: al} = ks, Sr = () => document.createComment(""), et = (e, t, n) => {
    ...
    return n;
}, _e = (e, t, n = e) => (e._$AI(t, n), e), sl = {}, ll = (e, t = sl) => e._$AH = t, cl = (e) => e._$AH, dn = (e) => {
    e._$AP?.(!1, !0);
    let t = e._$AA;
...
for (var hn = 0; hn < 256; ++hn)
    x.push((hn + 256).toString(16).slice(1));
...
function gl(e, t, n) {
    ...
    e = e || {};
    var r = e.random || (e.rng || vl)();
    return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, hl(r);
}

const Dt = [], tt = [], sc = async (e, t, n) => {
    let r, i;
    t.reqId = gl();
...
function uc() {
    const e = b.jdkInfo;
    return e == null || ao() !== "success" ? "none" : e.jrebel ? "jrebel" : e.runningWitHotswap ? "hotswap" : "none";
}
...
function Tl() {
    ...
    const e = ao(), t = kl();
    return e === "warning" ? t === "warning" ? {status: "warning", message: "IDE Plugin, Hotswap"} : {
        status: "warning",
        message: "Hotswap is not enabled"
    } : t === "warning" ? {status: "warning", message: "IDE Plugin is not active"} : e === "error" ? {
        status: "error",
...
var jl = Object.defineProperty, Rl = Object.getOwnPropertyDescriptor, Ml = (e, t, n, r) => {
    for (var i = r > 1 ? void 0 : r ? Rl(t, n) : t, o = e.length - 1, a; o >= 0; o--)
...
let Dr = class extends Ms {
    constructor() {
        super(...arguments), this.removers = [], this.initialized = !1, this.toggleOperationInProgressAttr = () => {
            ...
            ut(e.target?.owner) || (b.active || ut(e.detail.sourceEvent.target)) && e.preventDefault();
        };
    }
    ...
    async init() {
        if (this.initialized)
            return;
        await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-C9Mz8vXd.js"), await import("./copilot-init-step2-DnjASeUM.js"), Ls(), this.tabIndex = 0, At.hostConnectedCallback(), window.addEventListener("keydown", Or), E.onSend(this.handleSendEvent), this.removers.push(E.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
        ...
        ), ue.getCopilotActivation() && Pi().then(() => {
     ...
     */
    activate() {
        tn("activate"), At.activate(), Pr.copilotActivated(), Us(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), Ye.onCopilotActivation(), E.emit("component-tree-updated", {}), Zi.loadPreviewConfiguration();
    }
     ...
     */
    deactivate() {
        this.closeDrawers(), At.deactivate(), Pr.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), Ye.onCopilotDeactivation();
    }

    disconnectedCallback() {
        super.disconnectedCallback(), At.hostDisconnectedCallback(), window.removeEventListener("keydown", Or), E.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), Ye.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
    }
    ...
    closeDrawers() {
        ...
        const i = ls(r, "copilot-drawer-panel");
        if (!i) {
            e.forEach((o) => {
                o.opened = !1;
            });
