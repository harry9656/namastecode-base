import { a as k, _ as D, y as b, N as E, $, e as f, u as c, a0 as w, E as S, a1 as T, T as A, M as P, b as R, l as C } from "./copilot-D11KzKKd.js";
import { r as I } from "./state-Bmc-LnRe.js";
import { B as H } from "./base-panel-BUjfv_Bo.js";
import { showNotification as N } from "./copilot-notification-C3QdZgiY.js";
import { i as m } from "./icons-Dw7Bm2ra.js";
...
var M = J;
const V = /* @__PURE__ */ k(M);
var W = Object.defineProperty, _ = Object.getOwnPropertyDescriptor, g = (e, t, o, s) => {
  for (var r = s > 1 ? void 0 : s ? _(t, o) : t, n = e.length - 1, l; n >= 0; n--)
...
let x = class extends P {
  ...
  render() {
    return c`<button title="Copy to clipboard" aria-label="Copy to clipboard" theme="icon tertiary">
      <span
        @click=${() => {
      R.emit("system-info-with-callback", {
        callback: V,
        notify: !0
      });
    }}
